...
useHead({ title: 'About — Count Gouda' })
</script>

<template>
  <div class="pt-12 pb-20 px-6 md:px-12 max-w-2xl mx-auto">
    ...
    <div class="font-body text-ink-200 text-xl leading-relaxed space-y-6">
      ...
      <p>
        The work lives in the tension between the formal and the fantastical — anatomical discipline
        in service of worlds that don't exist.
      </p>
